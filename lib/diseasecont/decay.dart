            ...
            child: DefaultTabController(
              ...
              child: Scaffold(
                ...
                appBar: AppBar(
                  ...
                  title: Text(S.of(context).decay_title, style: TextStyle(color: Colors.white, fontSize: 20)),
                  backgroundColor: Colors.green[800],
                  bottom: TabBar(
                ...
                body: TabBarView(
                  children: [
                    Container(
                      ...
                      child: Center(
                        child: Text(
                          S.of(context).decay_description_text,
                    ...
                    Container(
                      ...
                      child: Center(
                        child: Text(
                          S.of(context).decay_symptoms_text,
                          style: TextStyle(fontWeight: FontWeight.bold),
                        ),
                      ),
                    ),
                    Container(
                      ...
                      child: Center(
                        child: Text(
                          S.of(context).decay_management_text,
                          style: TextStyle(fontWeight: FontWeight.bold),
                        ),
                      ),
                    ),
